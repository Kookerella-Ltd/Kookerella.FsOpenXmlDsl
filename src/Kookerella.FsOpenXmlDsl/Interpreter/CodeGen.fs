...
module internal CodeGen =
    ...
    /// caller needs to locate the Kookerella.FsOpenXmlDsl assembly - this module has no opinion on
    ...
    let generate (referenceLines: string list) (outputFileName: string) (wb: Workbook) : string =
        ...
        sb.AppendLine("open Kookerella.FsOpenXmlDsl") |> ignore
        sb.AppendLine("open type Kookerella.FsOpenXmlDsl.SheetDsl") |> ignore
        sb.AppendLine() |> ignore
