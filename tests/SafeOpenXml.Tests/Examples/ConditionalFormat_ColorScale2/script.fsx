...
let sheet0 = sheet "Sheet1" [ row [ cell (Number 10.0) ]; row [ cell (Number 50.0) ]; row [ cell (Number 90.0) ]; conditionalFormat ((CellRef.ofA1 "A1"), (CellRef.ofA1 "A3"), ColorScale2(Rgb(255uy, 255uy, 255uy), Rgb(255uy, 0uy, 0uy))) ]
